                ...
                <div class="col-md-7">
                    <div class="card m-0 ">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Guru Sekolah : <?= $users['school']; ?></li>
                            <li class="list-group-item">Siswa : <?php foreach ($siswa as $s) : ?>
                                <br><a href="<?= base_url('mentor/detail_datastudent/'); ?><?= $s['id_user']; ?>"><?= $s['name_user']; ?> | <?= $jur[$s['id_jurusan']]; ?></a>
                                <?php endforeach;  ?>
                            <?php
                            $hari_indonesia = [
                                'Sunday' => 'Minggu',
